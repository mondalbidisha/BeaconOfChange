    ...
    <main className="relative min-h-screen w-full overflow-y-auto overflow-x-hidden bg-gradient-to-b from-slate-950 via-indigo-950 to-slate-800 px-20 pb-20 pt-10">
      ...
      <FadeIn>
        <div className="flex items-center text-justify my-10 flex-col text-slate-100 gap-2 text-lg px-20">
          Implementing fuel-efficient technologies in vehicles and aircraft can significantly reduce emissions. For
          example, improving vehicle fuel efficiency by just 10% globally could prevent millions of tons of CO2 from
      ...
      <FadeIn>
        <div className="flex items-center text-justify my-10 flex-col text-slate-100 gap-2 text-lg px-20">
          Transitioning to alternative fuels like biofuels, hydrogen, or electric power for vehicles and aircraft can
          further reduce carbon emissions. These alternatives offer promising pathways to decarbonize transport and
          mitigate its impact on climate change.
        </div>
      </FadeIn>
      <FadeInStagger />
      <FadeIn>
