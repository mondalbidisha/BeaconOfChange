	...
	const homeEnergyFacts: Fact[] = [
		{
			...
			description: "The energy supply sector (electricity, heat, and other energy) is the largest contributor to global greenhouse gas emissions, responsible for approximately 35% of total emissions. Globally, residential and commercial buildings consume over half of all electricity.",
		...
		},
		{
			...
			description: "Energy demand for cooling is the fastest growing end-use in buildings, with ten air conditioners expected to be sold every second over the next 30 years. Emissions from air conditioning and refrigeration are expected to rise 90% from 2017 levels by 2050.",
			className: "col-span-3 lg:col-span-2 hover:outline outline-2 outline-offset-2 outline-slate-100",
			background: (
				<motion.img 
		...
		},
		{
			...
			description: "Switching to renewable energy sources, such as solar, wind, or hydroelectric power, means less pollution and the creation of new and better jobs. Currently, around 80% of global energy and 66% of electrical generation are supplied from fossil fuels.",
			className: "col-span-3 lg:col-span-1 hover:outline outline-2 outline-offset-2 outline-slate-100",
			background: (
				<motion.img 
    ...
    <main className="relative min-h-screen w-full overflow-y-auto overflow-x-hidden bg-gradient-to-b from-slate-950 via-indigo-950 to-slate-800 px-20 pb-20 pt-10">
        ...
        <FadeIn>
					<div className="flex items-center text-justify mb-10 flex-col text-slate-100 gap-2 text-lg px-20">
						Home energy use significantly impacts climate change due to the large amount of energy consumed in residential settings for heating, cooling, lighting, and appliances. 
						As homes rely heavily on electricity and other energy sources, often derived from fossil fuels, the carbon footprint of household energy use contributes notably to greenhouse gas emissions. 
					</div>
        </FadeIn>
        <FadeInStagger />
        <FadeIn>
					<div className="flex items-center text-justify mb-10 flex-col text-slate-100 gap-2 text-lg px-20">
						...
						Oqing to global warming the demand for cooling is the fastest-growing end-use in residential buildings. 
						Over the next 30 years, it is expected that ten air conditioners will be sold every second, leading to a significant rise in emissions.
					</div>
        </FadeIn>
        <FadeInStagger />
				<FadeIn>
					<div className="flex items-center text-justify mb-10 flex-col text-slate-100 gap-2 text-lg px-20">
						Some hard hitting statistics that outline the alarming rate at which energy is being consumed and the effect it has on our ecosystem are discussed here as follows -
					</div>
				</FadeIn>
				<FadeInStagger />
        <FadeIn>
