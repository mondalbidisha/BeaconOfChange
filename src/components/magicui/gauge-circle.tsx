...
export default function GaugeCircle({
  ...
  return (
    <div
      className={cn('relative h-60 w-60 text-2xl font-semibold', className)}
      style={
        {
          '--circle-size': '100px',
    ...
    >
      ...
      <span
        ...
        className="text-slate-50 duration-[var(--transition-length)] delay-[var(--delay)] absolute inset-0 m-auto h-fit w-fit ease-linear animate-in fade-in"
      >
        {currentPercent}
      </span>
    </div>
