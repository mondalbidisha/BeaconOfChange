    ...
    <main className="relative min-h-screen w-full overflow-y-auto overflow-x-hidden bg-gradient-to-b from-slate-950 via-indigo-950 to-slate-800 px-20 pb-20 pt-10">
        ...
        <FadeIn>
            <div className="flex items-center text-justify mb-10 flex-col text-slate-100 gap-2 text-lg px-20">
                As individuals we need to collectively work towards mitigating these impacts. Introduction of significant changes in food production and consumption are necessary. 
                One effective strategy is shifting dietary patterns toward plant-based foods, which have a lower environmental footprint. 
                Additionally, reducing food waste at consumer and production levels can conserve resources and lower emissions.
            </div>
        </FadeIn>
        <FadeInStagger />
        <FadeIn>
            <div className="flex items-center text-justify mt-10 mb-10 flex-col text-slate-100 gap-2 text-lg px-20">
                By embracing sustainable agricultural practices, promoting plant-based diets, and minimizing food waste, we can significantly reduce the environmental impact of our food systems and contribute to the fight against climate change.
            </div>
        </FadeIn>
        <FadeInStagger />
        <FadeIn>
            <div className="flex items-center text-justify mt-10 mb-10 flex-col text-slate-100 gap-2 text-lg px-20">
                Each one us can do our bit to plateau the impact. Here&apos;s how each one of us can make sustainable food choices ...
            </div>
        </FadeIn>
        <FadeInStagger />
        <FadeIn>
