      ...
      <div className="flex items-center text-justify flex-col text-slate-100 gap-2 px-10 mb-10">
        <MagicContainer className={'flex h-[500px] w-full flex-col gap-4 lg:h-[250px] lg:flex-row'}>
          ...
          >
            ...
            />
            <p className="z-10 text-4xl font-medium text-slate-50">Food</p>
          </MagicCard>
          <MagicCard
            borderwidth={3}
            className="flex w-full cursor-pointer flex-col items-center justify-center overflow-hidden p-10 shadow-2xl hover:outline outline-2 outline-offset-2 outline-slate-100"
          ...
          >
            <motion.img
              ...
              className="absolute h-full w-full object-cover brightness-40"
            />
            <p className="z-10 text-4xl font-medium text-slate-50">Water</p>
          </MagicCard>
          <MagicCard
            borderwidth={3}
            className="flex w-full cursor-pointer flex-col items-center justify-center overflow-hidden p-10 shadow-2xl hover:outline outline-2 outline-offset-2 outline-slate-100"
          ...
          >
            <motion.img
              ...
              className="absolute h-full w-full object-cover brightness-40"
            />
            <p className="z-10 text-4xl font-medium text-slate-50">Fashion</p>
          </MagicCard>
        </MagicContainer>
      </div>
      <div className="flex items-center text-justify flex-col text-slate-100 gap-2 px-10 mb-10">
        <MagicContainer className={'flex h-[500px] w-full flex-col gap-4 lg:h-[250px] lg:flex-row'}>
          ...
          >
            <motion.img
              ...
              className="absolute h-full w-full object-cover brightness-40"
            />
            <p className="z-10 text-4xl font-medium text-slate-50">Home Energy</p>
          </MagicCard>
          <MagicCard
            borderwidth={3}
            className="flex w-full cursor-pointer flex-col items-center justify-center overflow-hidden p-10 shadow-2xl hover:outline outline-2 outline-offset-2 outline-slate-100"
          ...
          >
            <motion.img
              ...
              className="absolute h-full w-full object-cover brightness-40"
            />
            <p className="z-10 text-4xl font-medium text-slate-50">Transport</p>
          </MagicCard>
          <MagicCard
            borderwidth={3}
            className="flex w-full cursor-pointer flex-col items-center justify-center overflow-hidden p-10 shadow-2xl hover:outline outline-2 outline-offset-2 outline-slate-100"
          ...
          >
            <motion.img
              ...
              className="absolute h-full w-full object-cover brightness-40"
            />
            <p className="z-10 text-4xl font-medium text-slate-50">Waste</p>
          </MagicCard>
        </MagicContainer>
      </div>
    </>
