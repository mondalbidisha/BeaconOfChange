...
const climateChangeFacts: Fact[] = [
  {
    ...
    description:
      'Climate change is already affecting every region on Earth. Changes in rainfall patterns, rising sea levels, melting glaciers, a warming ocean, and more frequent and intense extreme weather events are just some of the changes already impacting millions of people.',
  ...
  },
  {
    ...
    description:
      'With every increment of global warming, extreme heat and rainfall events become more frequent and more intense. We have already crossed the 1.1°C mark and if global warming exceeds 1.5°C above pre-industrial levels, there will be more heat waves, longer warm seasons and shorter cold seasons.',
    className: 'col-span-3 lg:col-span-2 hover:outline outline-2 outline-offset-2 outline-slate-100',
    background: (
      <motion.img
  ...
  },
  {
    ...
    description:
      'The main cause of climate change – the burning of coal, oil and gas – also causes air pollution which in turn can lead to respiratory diseases, strokes, and heart attacks. More than 8.7 million people currently die every year due to outdoor air pollution.',
    className: 'col-span-3 lg:col-span-1 hover:outline outline-2 outline-offset-2 outline-slate-100',
    background: (
      <motion.img
  ...
  },
  {
    ...
    description:
      'In most parts of the world, electricity from new renewable-energy plants, such as wind or solar, is now cheaper than power from new fossil fuel plants.',
    className: 'col-span-3 lg:col-span-1 hover:outline outline-2 outline-offset-2 outline-slate-100',
    background: (
      <motion.img
  ...
  },
  {
    ...
    description:
      'The transition to net-zero emissions is projected to lead to an overall increase in jobs in the energy sector: about 5 million jobs in fossil fuel production could be lost by 2030, but an estimated 14 million new jobs would be created in clean energy.',
    className: 'col-span-3 lg:col-span-1 hover:outline outline-2 outline-offset-2 outline-slate-100',
    background: (
      <motion.img
  ...
  },
  {
    ...
    description:
      'The choices we make today will determine the changes in the climate we will experience in the future. If we act now, we can limit climate change and preserve a livable planet.',
    className: 'col-span-3 lg:col-span-1 hover:outline outline-2 outline-offset-2 outline-slate-100',
    background: (
      <motion.img
